...
class MoodEntrySQLiteDBHelper(context: Context?) : SQLiteOpenHelper(
    ...
    override fun onCreate(sqLiteDatabase: SQLiteDatabase) {
        ...
        saveMood(MoodEntry(Mood.COPING, 1734628096994, "Rough day", "CODING, SLEEP", "SUNNY"), sqLiteDatabase)
        saveMood(MoodEntry(Mood.DOWN, 1734460200000, "Still not so happy", "EXERCISE", "RAINY"), sqLiteDatabase)
        saveMood(MoodEntry(Mood.NEUTRAL, 1734373800000, "A little better", "SLEEP", "RAINY"), sqLiteDatabase)
        saveMood(MoodEntry(Mood.COPING, 1734287400000, "Much better", "SOCIALIZING", "CLOUDY"), sqLiteDatabase)
        saveMood(MoodEntry(Mood.NEUTRAL, 1734201000000, "Lots of work", "SLEEP", "SUNNY"), sqLiteDatabase)
        saveMood(MoodEntry(Mood.ELATED, 1734114600000, "Got some praise!", "SOCIALIZING", "RAINY"), sqLiteDatabase)
        saveMood(MoodEntry(Mood.NEUTRAL, 1734028200000, "Wish I could hug my friends", "SLEEP", "CLOUDY"), sqLiteDatabase)
        saveMood(MoodEntry(Mood.NEUTRAL, 1733941800000, "Work again", "EXERCISE", "SUNNY"), sqLiteDatabase)
